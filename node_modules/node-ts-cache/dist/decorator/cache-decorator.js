...
var debug = debug_1.default("node-ts-cache");
    ...
    return function (target, methodName, descriptor) {
        ...
        descriptor.value = function () {
            ...
            return __awaiter(this, void 0, void 0, function () {
                var keyOptions, cacheKey, entry, methodCall, methodResult;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            if (!(methodCall && methodCall.then)) return [3 /*break*/, 3];
                        ...
                        case 3:
                            ...
                            _a.label = 4;
                        case 4: return [4 /*yield*/, container.setItem(cacheKey, methodResult, options)];
                        case 5:
                            _a.sent();
        ...
        debug("Added caching support for method " + className + ":" + methodName.toString());
        return descriptor;
    };
}
exports.Cache = Cache;
